...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold">Workers minimum wage</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('minimum_wage.workercount.index')}}" method="GET" onchange="this.submit();">
                ...
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="{{route('minimum_wage.workercount.update',$data->id)}}" method="POST">
                                @csrf
                                @method('patch')
                            ...
                            <x-status.action-status :status="$data->worker_status" :id="$data->id" :edit="'minimum_wage.workercount.edit'"/>
                            </form>
                        @empty
                        <tr>
