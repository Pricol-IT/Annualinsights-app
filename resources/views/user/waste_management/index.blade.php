    ...
    <div class="container">
        ...
        <div class=" card">
            ...
            <div class="card-header">
                <form id="formSubmit" action="{{route('waste_management.index')}}" method="GET" onchange="this.submit();">
            ...
            <div class="card-body table-responsive">
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        @endforelse
                        <tr>
                            <form id="formSubmit" action="{{route('waste_management.create')}}" method="POST">
                                @csrf
