...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold">Workers Turnover</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('turnover.workercount.index')}}" method="GET" onchange="this.submit();">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('turnover.workercount.edit', $data->id) }}" class="btn btn-sm btn-warning">
