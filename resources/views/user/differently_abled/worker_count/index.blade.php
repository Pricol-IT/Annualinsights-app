...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold"> Differently Abled Workers</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('differently_abled.workercount.index')}}" method="GET" onchange="this.submit();">
                ...
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <x-status.actionStatus :status="$data->worker_status" :id="$data->id" :edit="'differently_abled.workercount.edit'"/>
