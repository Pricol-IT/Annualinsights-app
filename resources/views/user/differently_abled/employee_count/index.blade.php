...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold">Differently Abled Employees</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('differently_abled.employeecount.index')}}" method="GET" onchange="this.submit();">
                ...
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <x-status.actionStatus :status="$data->employee_status" :id="$data->id" :edit="'differently_abled.employeecount.edit'"/>
