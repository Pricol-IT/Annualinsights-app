                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="pe_remark" id="pe_remark" class="form-control class " value="{{$data->pe_remark}}" placeholder="Enter the remark">
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="te_remark" id="te_remark" class="form-control class " value="{{$data->te_remark}}" placeholder="Enter the remark">
                                    </div>
                                </div>
