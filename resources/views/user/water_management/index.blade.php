    ...
    <div class="container">
        ...
        <div class=" card">
            ...
            <div class="card-header">
                <form id="formSubmit" action="{{route('water_management.index')}}" method="GET" onchange="this.submit();">
            ...
            <div class="card-body table-responsive">
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('water_management.edit', $data->id) }}" class="btn btn-sm btn-light">
                        ...
                        @endforelse
                        <tr>
                            <form id="formSubmit" action="{{route('water_management.create')}}" method="POST">
                                @csrf
