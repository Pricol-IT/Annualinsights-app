...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold">Hiring Employees Count</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('hiring.employeecount.index')}}" method="GET" onchange="this.submit();">
                ...
                <table class=" table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->te_other}}</td>
                            <x-status.action-status :status="$data->employee_status" :id="$data->id" :edit="'hiring.employeecount.edit'"/>
