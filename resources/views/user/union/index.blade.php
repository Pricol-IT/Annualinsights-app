...
<main id="main" class="main">
    <div class="container">
        ...
        <h3 class="fw-bold">Union</h3>
        <div class=" card">
            @csrf
            <div class="card-header">
                <form id="formSubmit" action="{{route('union.index')}}" method="GET" onchange="this.submit();">
                ...
                <table class=" table ">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2" style="text-align: center;">Workers </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->remarks}}</td>
                            <x-status.actionStatus :status="$data->status" :id="$data->id" :edit="'union.edit'"/>
