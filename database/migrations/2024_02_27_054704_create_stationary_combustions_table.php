...
return new class extends Migration {
    ...
    {
        Schema::create('stationary_combustions', function (Blueprint $table) {
            $table->id();
            $table->string('year');
            ...
            $table->string('fueltype_other')->nullable();
            $table->enum('unit',['Litres','Kg']);
            $table->string('total_comsumption');
    ...
    {
        Schema::dropIfExists('stationary_combustions');
    }
};
